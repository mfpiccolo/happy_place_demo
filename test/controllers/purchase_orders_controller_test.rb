...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { important_info: @purchase_order.important_info, order_id: @purchase_order.order_id, state: @purchase_order.state }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { important_info: @purchase_order.important_info, order_id: @purchase_order.order_id, state: @purchase_order.state }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
